...
public class ShapeManagerTest {
    ...
    public void calculateTotalVolume() throws Exception {
        ...
        Assert.assertEquals(0.0, shapeManager.calculateTotalVolume(), 0.00001);
        ...
        Assert.assertEquals(1098.53678, shapeManager.calculateTotalVolume(), 0.00001);
 ...
 Assert.assertEquals(11416.6596143, shapeManager.calculateTotalVolume(), 0.0001);
 ...
 Assert.assertEquals(77285.5760274, shapeManager.calculateTotalVolume(), 0.0001);
